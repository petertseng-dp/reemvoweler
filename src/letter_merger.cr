class LetterMerger
  ...
  def merge(letters : Array(Array(Char)), prefix = "") : Array(Array(String))
  ...
  private def try_append(letters : Array(Array(Char)), i : Int32, prefix : String) : Array(Array(String))
  ...
  private def try_new_word(letters : Array(Array(Char)), prefix : String) : Array(Array(String))
